...
import { UppyUploaderService, UppyFileData } from '@v3/components/uppy-uploader/uppy-uploader.service';
import { UtilsService } from '@v3/services/utils.service';
import { NotificationsService } from '@v3/app/services/notifications.service';

const mockUppyFile = (overrides: Partial<UppyFileData> = {}): UppyFileData => ({
  source: 'test',
  id: 'test-id',
  name: 'test-file',
  extension: 'jpg',
  meta: { relativePath: null, name: 'test-file', type: 'image/jpeg' },
  type: 'image/jpeg',
  data: {},
...
describe('SupportPopupComponent', () => {
  ...
  describe('isPristine', () => {
    ...
    it('should return false when selectedFile is truthy', () => {
      component.problemSubject = '';
      component.problemContent = '';
      component.selectedFile = mockUppyFile();
  ...
  describe('uploadFile', () => {
    it('should open uppy uploader and set selectedFile on dismiss with data', fakeAsync(() => {
      const mockFile = mockUppyFile({ name: 'test.jpg', url: 'http://example.com/test.jpg' });
